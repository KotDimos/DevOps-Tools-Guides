...
> * [Узнать текущую рабочую директорию](#узнать-текущую-рабочую-директорию)
> * [Навигация по директориям](#навигация-по-директориям)
> * [Просмотр содержимого директории](#просмотр-содержимого-директории)
> * [Просмотр директории в древовидной форме](#просмотр-директории-в-древовидной-форме)
...
> * [Удаление файлов и директорий](#удаление-файлов-и-директорий)

* [Манипуляция с текстом](#манипуляция-с-текстом)
> * [Вывод содержимого файла](#вывод-содержимого-файла)
> * [Просмотр первых строк файла](#просмотр-первых-строк-файла)
> * [Просмотр последних строк файла](#просмотр-последних-строк-файла)
> * [Справочник по командам](#справочник-по-командам)
> * [Вывод текста](#вывод-текста)
> * [Перенаправление потока](#перенаправление-потока)
> * [Поиск текста](#поиск-текста)
> * [Сортировка](#сортировка)
> * [Редактирование текста с помощью sed](#редактирование-текста-с-помощью-sed)
> * [Поиск файлов](#поиск-файлов)
> * [Awk](#awk)
> * [Подсчёт повторяющихся строк](#подсчёт-повторяющихся-строк)
> * [Обрезка текста](#обрезка-текста)
> * [Замена символов](#замена-символов)
> * [Подсчёт количества строк и слов](#подсчёт-количества-строк-и-слов)

* [Права файлов](#права-файлов)
> * [Смена прав файла и директории](#смена-прав-файла-и-директории)
> * [Смена владельца файла и директории](#смена-владельца-файла-и-директории)
> * [Смена группы файла и директории](#смена-группы-файла-и-директории)
...
## Просмотр директории в древовидной форме
Для этого используется команда `tree`.
...
Для удаления директории есть специальная команда `rmdir`, но она работает только тогда, когда директория пустая.
...
## Редактирование текста с помощью sed
...
Так же хорошей практикой считается писать большие скрипты awk в файле, для более удобного чтения.
