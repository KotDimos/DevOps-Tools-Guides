...
> > * [Редактирование последнего коммита](#редактирование-последнего-коммита)
> > * [Редактирование сообщения нескольких коммитов](#редактирование-сообщения-нескольких-коммитов)
> > * [Объединение коммитов](#объединение-коммитов)
> > * [Смена коммитов местами](#смена-коммитов-местами)
