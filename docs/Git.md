...
> * [Перепись истории коммитов (filter-branch)](#перепись-истории-коммитов)
...
Для скачивания данных с удалённого сервера используется команда `git pull`.
