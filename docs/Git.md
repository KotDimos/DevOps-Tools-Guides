...
* [Ветвление](#ветвление)
    ...
    * [Перебазирование (rebase)](#пПеребазирование)
    * [Сравнение слияния и перебазирование веток](#сравнение-слияния-и-перебазирование-веток)
...
Для перебазирования ветки требуется перейти в ветку которую нужно перебазировать,
а потом указать ветку в которую будет перебазировать.

    git checkout <rebased-branch-name>
    git rebase <branch-name>

Можно перебазировать ветку, при этом находясь в другой ветке.

    git rebase <branch-name> <rebased-branch-name>

При возникновении конфликта перебазирования коммитов,
...
После перебазирования ветки,
можно выполнить перемотку ветки куда происходило перебазирование.
...
При возникновении конфликта можно отменить перебазирование.
...
Для перебазирования требуется перейти в ветку feature.

    git checkout feature

И запустить перебазирование.
...
и для того чтобы перемотать feature_2 к master.
...
## Сравнение слияния и перебазирование веток

[Наверх](#содержание)

Есть два вида соединения веток - слияние и перебазирование, что лучше?
...
на `squash` у коммита более нового коммита.


К примеру, нужно соединить коммиты 2, 3 и 4.
...
всех веток которые эта команда затронет,
будет создана копия веток по пути
...
Где b63eabe коммит более старый от ветки feature.
