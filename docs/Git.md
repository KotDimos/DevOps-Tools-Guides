...
> * [Просмотр истории коммитов (log)](#просмотр-истории-коммитов)
...
> * [Скачивание данных с сервера (pull)](#скачивание-данных-с-сервера)
> * [Загрузка коммитов с сервера (fetch)](#загрузка-коммитов-с-сервера)
> * [Тэги (tag)](#тэги)
...
> * [Редактирование нескольких коммитов (rebase)](#редактирование-нескольких-коммитов)
> * [Объединение коммитов (rebase)](#объединение-коммитов)
> * [Изменение порядка следования коммитов (rebase)](#изменение-порядка-следования-коммитов)
...
> * [Сборка мусора и оптимизация репозитория](#сборка-мусора-и-оптимизация-репозитория)
